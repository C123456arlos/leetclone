...
//     problemStatement: `<p class='mt-3'>given the <code> of a sinlgy linked list, reverse the list an return <em>
//     the reversed list</em>.</p>`,
//     examples: [
//         {
//             id: 0,
...
//         },
//     ],
//     constraints: `<li class='mt-2'> the number of nodes in the list is the range
//     <code>[0,500]</code>.</li>
