...
//     id: 'jump=game',
//     title: '3. jump game',
//     problemStatement: `<p class='mt-3> you are given an integer array <code>nums</code>. you are initially positioned at the <strong>first index</strong>
...
//             outputText: 'false',
//             explanation: 'you will always arrive at index 3 no matter what its maximum jump length is z-0, which makes it impossible to reach the last index'
//         }
//     ],
